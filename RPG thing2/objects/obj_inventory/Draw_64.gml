...
draw_text(__view_get( e__VW.WView, 0 )/2,20,string_hash_to_newline("Spells"));

draw_set_font(fnt_gui);
draw_text(__view_get( e__VW.WView, 0 )/3+16,64,string_hash_to_newline("Current Spells"));

draw_sprite(spr_inv_slot,0,__view_get( e__VW.WView, 0 )/2+8,48);
draw_sprite(spr_spell,current_spell_1,__view_get( e__VW.WView, 0 )/2+24,64);


draw_sprite(spr_inv_slot,0,__view_get( e__VW.WView, 0 )/2+48,48);
draw_sprite(spr_spell,current_spell_2,__view_get( e__VW.WView, 0 )/2+64,64);

draw_sprite(spr_inv_slot,0,__view_get( e__VW.WView, 0 )/2+88,48);
draw_sprite(spr_spell,current_spell_3,__view_get( e__VW.WView, 0 )/2+104,64);
