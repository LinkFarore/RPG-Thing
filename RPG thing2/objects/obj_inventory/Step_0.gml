...
cursor_y = (cursor_y + move_v + ((INVENTORY_SLOTS - 1) div row_length + 1)) % ((INVENTORY_SLOTS - 1) div row_length + 1);

// Handle wrapping around
if (cursor_x < 0) cursor_x = row_length - 1;
if (cursor_y < 0) cursor_y = ((INVENTORY_SLOTS - 1) div row_length);
...
if (keyboard_check_pressed(ord("J"))) || gamepad_button_check_pressed(0,gp_face3)
{
    ...
    {
        current_spell_1 = selected_index;
		
		if instance_exists(obj_player)
		{
			obj_player.spell_1 = current_spell_1+1;
			audio_play_sound(snd_menu_select,1,false);
		}
    }
}
...
if (keyboard_check_pressed(ord("K"))) || gamepad_button_check_pressed(0,gp_face4)
{
    ...
    if (inventory[selected_index] != -1)
    {
        current_spell_2 = selected_index;
		
		if instance_exists(obj_player)
		{
			obj_player.spell_2 = current_spell_2+1;
			audio_play_sound(snd_menu_select,1,false);
		}
    }
}
...
if (keyboard_check_pressed(ord("L"))) || gamepad_button_check_pressed(0,gp_face2)
{
    ...
    if (inventory[selected_index] != -1)
    {
        current_spell_3 = selected_index;
		
		if instance_exists(obj_player)
		{
			obj_player.spell_3 = current_spell_3+1;
			audio_play_sound(snd_menu_select,1,false);
		}
    }
}