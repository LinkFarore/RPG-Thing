...
draw_sprite(spr_rupee,0,11,167);
...
draw_text(26,167, string_hash_to_newline(string(global.rupee)));
}
else
{
...
if global.poh = 0
{
draw_sprite(spr_poh_gui,0,222,3);
}

if global.poh = 1
{
draw_sprite(spr_poh_gui,1,222,3);
}

if global.poh = 2
{
draw_sprite(spr_poh_gui,2,222,3);
}

if global.poh = 3
{
draw_sprite(spr_poh_gui,3,222,3);
}

if global.poh = 4
{
draw_sprite(spr_poh_gui,4,222,3);
}
...
draw_text(196,152,string_hash_to_newline("Level: " + string(level)));

if xp > 0
{
draw_rectangle_colour(200,164,200+(xp*50/maxxp),172,c_gray,c_white,c_white,c_gray,false);
}
draw_sprite(spr_bar,0,200,164);

/* */
///Keep health bar
if keep_collide = true
{
    if keep > 0
    {
        draw_set_halign(fa_left);
        draw_rectangle_colour(200,__view_get( e__VW.HView, 0 )/2,200+(keep*50/10),__view_get( e__VW.HView, 0 )/2+2,color,c_white,c_white,color,false);
    }
    draw_sprite(spr_keep_bar,0,200,__view_get( e__VW.HView, 0 )/2);
    draw_set_color(color);
    draw_set_font(fnt_level);
    draw_set_halign(fa_right);
    draw_set_valign(fa_top);
    draw_text(252,__view_get( e__VW.HView, 0 )/2-12,string_hash_to_newline(text));
}
