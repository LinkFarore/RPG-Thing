if hurt = true || stun = true || shoot = false
{exit}
...
if eneDir = 0 && place_meeting(x-8,y,obj_player) && place_meeting(x-8,y-grid,obj_player) { eneDir = 1 }
if eneDir = 1 && place_meeting(x+8,y,obj_player) && place_meeting(x+8,y-grid,obj_player) { eneDir = 0 }
