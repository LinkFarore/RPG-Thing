...
if (foe != -1 && point_distance(x, y, foe.x, foe.y) <= attack_distance+sprite_width) 
{
	if (alarm[0] == -1 && weapon != -1) 
	{
	    ...
	    {
	        case 0:
	        var lazer = instance_create(x, y,obj_enemy_lazer);
	        ...
	        case 1:
	        var lazer1 = instance_create(x+lengthdir_x(5,image_angle+90), y+lengthdir_y(5,image_angle+90), obj_enemy_lazer);
	        var lazer2 = instance_create(x+lengthdir_x(5,image_angle-90), y+lengthdir_y(5,image_angle-90), obj_enemy_lazer);
	        ...
	        case 2:
	        var lazer1 = instance_create(x, y,obj_enemy_lazer);
	        var lazer2 = instance_create(x+lengthdir_x(8,image_angle+90), y+lengthdir_y(8,image_angle+90), obj_enemy_lazer);
	        var lazer3 = instance_create(x+lengthdir_x(8,image_angle-90), y+lengthdir_y(8,image_angle-90), obj_enemy_lazer);
	        lazer1.direction = image_angle;
	        lazer2.direction = image_angle;
