function save_loaded_chunks(cx, cy) {
	...
	//This will only check for a collision for objects that have a sprite assigned to them either manually or in the object properties
